...
sumOfLiterals (Add a b) =  sumOfLiterals a + sumOfLiterals b

numberOfAddNodes :: Expr -> Integer
numberOfAddNodes (Literal x) = 0
numberOfAddNodes (Add a b)  = 1 + numberOfAddNodes a + numberOfAddNodes b 


listOfLiterals :: Expr -> [Integer]
listOfLiterals (Literal x) = [x]
listOfLiterals (Add a b)  = listOfLiterals a ++ listOfLiterals b 
